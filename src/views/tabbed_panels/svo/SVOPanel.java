package views.tabbed_panels.svo;
...
public class SVOPanel extends JPanel 
{
	...
	private JComboBox combo_TimeRange;
	private JButton button_Calculate;
	
	private JCheckBox checkbox_Speed;
	private JCheckBox checkbox_Volume;
	private JCheckBox checkbox_Occupancy;
	private JButton button_Export;
	
	private JButton button_CalculateAll;

	private JComboBox combo_SVO1;
	private JComboBox combo_SVO2;
	private JComboBox combo_SVO3;
	private JComboBox combo_SVO4;
	private JComboBox combo_SVO5;
	
	private JComboBox combo_Channel1;
	private JComboBox combo_Channel2;
	private JComboBox combo_Channel3;
	private JComboBox combo_Channel4;
	private JComboBox combo_Channel5;
	...
	public SVOPanel() 
	{
		...
		JLabel lblcalculatesDatafromBeginning = new JLabel("<html><em><center>Calculates data<br>from beginning to end</center></em></html>");
		lblcalculatesDatafromBeginning.setHorizontalAlignment(SwingConstants.CENTER);
		lblcalculatesDatafromBeginning.setFont(new Font("Lucida Grande", Font.PLAIN, 10));
		lblcalculatesDatafromBeginning.setBounds(589, 36, 117, 48);
		panel.add(lblcalculatesDatafromBeginning);
